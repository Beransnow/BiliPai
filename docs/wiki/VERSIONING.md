...
| 位置 | 内容 |
| --- | --- |
| `versionName` / APK 名 | `0.2.0` |
| 关于页建议 | `v0.2.0 · 284`，并可附短 commit / 构建日期 |
...
Release APK：`BiliPai-<versionName>.apk`，例如 `BiliPai-0.2.0.apk`。  
...
| 命令 | 用户交付文件 |
| --- | --- |
| `./gradlew :app:assembleRelease` | `app/build/outputs/bilipai/release/BiliPai-0.2.0.apk` |
| `./gradlew :app:assembleDev` | `app/build/outputs/bilipai/dev/BiliPai-0.2.0-dev.apk` |
