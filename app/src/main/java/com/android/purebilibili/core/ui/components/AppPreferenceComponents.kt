 ...
 *
 * Phase 1 deliberately delegates to the proven adaptive renderers so callers can move away
 * from historical IOS* names without changing layout, interaction, haptics, or persistence.
 */
@Composable
