...
internal val miuixCardBackTransitionEnabledPreferencesKey =
    booleanPreferencesKey("miuix_card_back_transition_enabled")
internal val miuixCardBackMaxProgressPercentPreferencesKey =
    intPreferencesKey("miuix_card_back_max_progress_percent")
...
object NavigationSettingsStore {
    ...
    suspend fun setMiuixCardBackTransitionEnabled(context: Context, enabled: Boolean) {
        context.settingsDataStore.edit { preferences ->
            preferences[miuixCardBackTransitionEnabledPreferencesKey] = enabled
        }
    }

    suspend fun setMiuixCardBackMaxProgressPercent(context: Context, percent: Int) {
        context.settingsDataStore.edit { preferences ->
            preferences[miuixCardBackMaxProgressPercentPreferencesKey] = percent.coerceIn(0, 100)
        }
    }
