...
private val SETTINGS_SEARCH_INDEX: List<SettingsSearchEntry> = listOf(
    ...
    SettingsSearchEntry(
        ...
        section = "首页设置",
        aliases = listOf("首页展示", "首页与列表", "展示样式", "一键回顶", "回到顶部", "搜索回顶", "评论区回顶", "展示番剧影视时间表", "追番时间表", "影视时间表", "电影时间线", "首页壁纸", "首页壁纸效果", "原图壁纸", "壁纸模糊", "强模糊", "推荐流卡片宽度", "首页卡片宽度", "卡片宽度", "完整卡片", "完整标题", "完整内容", "PiliPlus排版", "统计信息贴封面", "UP主标识", "UP标识", "up主标识", "up标识", "UP主头像", "UP头像", "up主头像", "up头像", "隐藏头像"),
