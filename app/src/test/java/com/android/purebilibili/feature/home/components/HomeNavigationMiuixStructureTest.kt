...
class HomeNavigationMiuixStructureTest {
    ...
    fun `miuix auto floating bottom bar uses native Miuix icon pairs`() {
        ...
        assertTrue(iconPolicySource.contains("BottomNavItem.HOME -> ImageVector.vectorResource(R.drawable.ms_home_24)"))
        assertTrue(iconPolicySource.contains("BottomNavItem.HISTORY -> ImageVector.vectorResource(R.drawable.ms_history_24)"))
