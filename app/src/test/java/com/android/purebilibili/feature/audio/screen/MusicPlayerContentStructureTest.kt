...
class MusicPlayerContentStructureTest {
    ...
    fun `lyrics expose progress playback controls and immersive chrome`() {
        ...
        assertTrue(lyricsControls.contains("val panelColor = AppSurfaceTokens.cardContainer()"))
        assertTrue(lyricsControls.contains("shape = AppShapes.container(ContainerLevel.Floating)"))
