...
当前构建为 `0.2.0 / versionCode 284`（语义化 `MAJOR.MINOR.PATCH`）；最新完整发布记录为 `v0.2.0`。源码与变更以 GitHub 和 [CHANGELOG.md](CHANGELOG.md) 为准；安装包与公告见 [Telegram 频道](https://t.me/bilipai666) / [交流群](https://t.me/bilipai888/1)：
