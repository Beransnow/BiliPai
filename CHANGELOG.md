...
### 视觉与顶栏模糊
[重构] 「顶部渐进模糊」与「顶部栏磨砂」彻底解耦与独立，支持互斥联动与独立开关控制
[修复] 消除顶部状态栏下方的渐变断层阶梯横线（`startFraction` 调平至 0f），实现顶栏到内容的无缝羽化过渡
[修复] 修复渐进模糊开关逻辑反向问题，确保开关状态与底层渲染精准对应
[优化] 动态、搜索、分区、稍后再看与二级设置页全面接入独立渐进模糊与磨砂互斥策略

### 主题与顶栏规范
[优化] MIUIX 主题下一级设置页面标题左对齐于导航返回键右侧，对齐系统规范
[优化] MD3 主题下二级设置页面标题居中对齐，遵循 Material 3 规范
